...
export const LoginMenu = () => {
   ...
   return (
      <div className="menu-container baseTablet:rounded-t-lg">
         ...
         <LoginAuthForm />
         <div className="absolute bottom-0 z-[303] flex w-full flex-col items-center justify-center gap-1 rounded-b-lg border-t border-gray-200 bg-gray-100 py-[16px] text-[16px] font-normal text-gray-600 standalone:bottom-14 baseTablet:translate-y-full">
