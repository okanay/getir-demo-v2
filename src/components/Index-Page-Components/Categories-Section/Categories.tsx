...
export const Categories = () => {
   ...
   return (
      <section
         ...
         {/*Categories*/}
         <div className="grid h-fit w-full grid-cols-4 items-center gap-2 px-1 baseTablet:grid-cols-5 baseTablet:px-0 lgTablet:grid-cols-10 lgTablet:gap-4 lgTablet:px-0">
            <CategoryItems />
         </div>
      </section>
   )
