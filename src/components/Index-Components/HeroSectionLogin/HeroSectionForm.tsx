...
export const HeroSectionForm = () => {
   ...
   return (
      <form className="flex flex-col items-center justify-center gap-2 bg-slate-100 px-4 py-4 text-center text-[16px] font-semibold baseTablet:w-[25rem] baseTablet:gap-2 baseTablet:rounded-lg baseTablet:px-5 baseTablet:py-6">
         ...
         <button
            type={'button'}
            className="group w-full rounded-lg border border-slate-200 bg-yellow-400 py-4 text-center text-[14px] text-skin-theme-700 transition-colors duration-200 hover:bg-skin-theme-700 hover:text-yellow-400">
            {t('loginButton')}
         </button>
      </form>
   )
