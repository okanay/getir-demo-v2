...
export const HeroSectionLogin = () => {
   return (
      <div className={'flex h-full w-full flex-col font-helvatice'}>
         ...
         <div className="flex flex-col items-center justify-center bg-skin-theme-700 baseTablet:h-[32rem] baseTablet:px-4 lgTablet:px-12">
