...
export const LoadingItems = () => {
   return (
      <div className="flex h-full w-full flex-col items-start justify-start gap-2">
         <div className={'ml-4 h-5 w-[200px] animate-pulse bg-slate-400/40 baseTablet:ml-0'} />
   ...
   return (
      <article className={'grid h-[210px] w-full grid-rows-2 bg-white'}>
         <div className={'relative row-span-1 flex h-full w-full flex-col items-center justify-center'}>
            <div className={'mt-4 h-[80px] w-[80px] animate-pulse rounded-full bg-gray-200'}></div>
